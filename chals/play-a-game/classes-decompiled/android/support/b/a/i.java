...
public class i extends h
{
    ...
    public static i a(final Resources resources, int next, final Resources$Theme resources$Theme) {
        if (Build$VERSION.SDK_INT >= 24) {
            final i i = new i();
            i.b = android.support.v4.b.a.b.a(resources, next, resources$Theme);
            i.h = new g(i.b.getConstantState());
            return i;
        }
        try {
    ...
    public static i a(final Resources resources, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) {
        final i i = new i();
    ...
    private void a(final TypedArray typedArray, final XmlPullParser xmlPullParser) {
        final f c = this.c;
        final e b = c.b;
        c.d = a(android.support.v4.b.a.c.a(typedArray, xmlPullParser, "tintMode", 6, -1), PorterDuff$Mode.SRC_IN);
        final ColorStateList colorStateList = typedArray.getColorStateList(1);
        if (colorStateList != null) {
            c.c = colorStateList;
        }
        c.e = android.support.v4.b.a.c.a(typedArray, xmlPullParser, "autoMirrored", 5, c.e);
        b.d = android.support.v4.b.a.c.a(typedArray, xmlPullParser, "viewportWidth", 7, b.d);
        b.e = android.support.v4.b.a.c.a(typedArray, xmlPullParser, "viewportHeight", 8, b.e);
        if (b.d <= 0.0f) {
        ...
        b.setAlpha(android.support.v4.b.a.c.a(typedArray, xmlPullParser, "alpha", 4, b.getAlpha()));
    ...
    private boolean a() {
        return Build$VERSION.SDK_INT >= 17 && (this.isAutoMirrored() && android.support.v4.c.a.a.g(this) == 1);
    }
    ...
    public void inflate(final Resources resources, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) {
        ...
        final f c = this.c;
        c.b = new e();
        final TypedArray a = android.support.v4.b.a.c.a(resources, resources$Theme, set, android.support.b.a.a.a);
    ...
    private static class a extends d
    {
        ...
        private void a(final TypedArray typedArray) {
            ...
            if (string2 != null) {
                this.m = android.support.v4.c.b.b(string2);
            }
        }
        ...
        public void a(final Resources resources, final AttributeSet set, final Resources$Theme resources$Theme, final XmlPullParser xmlPullParser) {
            ...
            final TypedArray a = android.support.v4.b.a.c.a(resources, resources$Theme, set, android.support.b.a.a.d);
            this.a(a);
            a.recycle();
        }
    ...
    private static class b extends d
    {
        ...
        private void a(final TypedArray typedArray, final XmlPullParser xmlPullParser) {
            ...
            this.j = this.a(android.support.v4.b.a.c.a(typedArray, xmlPullParser, "strokeLineCap", 8, -1), this.j);
            this.k = this.a(android.support.v4.b.a.c.a(typedArray, xmlPullParser, "strokeLineJoin", 9, -1), this.k);
        ...
        public void a(final Resources resources, final AttributeSet set, final Resources$Theme resources$Theme, final XmlPullParser xmlPullParser) {
            final TypedArray a = android.support.v4.b.a.c.a(resources, resources$Theme, set, android.support.b.a.a.c);
            this.a(a, xmlPullParser);
            a.recycle();
        }
    ...
    private static class c
    {
        ...
        public c(c c, final android.support.v4.g.a<String, Object> a) {
            this.d = new Matrix();
            this.a = new ArrayList<Object>();
            this.b = 0.0f;
            this.e = 0.0f;
        ...
        public void a(final Resources resources, final AttributeSet set, final Resources$Theme resources$Theme, final XmlPullParser xmlPullParser) {
            final TypedArray a = android.support.v4.b.a.c.a(resources, resources$Theme, set, android.support.b.a.a.b);
            this.a(a, xmlPullParser);
            a.recycle();
        }
    ...
    private static class d
    {
        ...
        public d(final d d) {
            ...
            this.n = d.n;
            this.o = d.o;
            this.m = android.support.v4.c.b.a(d.m);
        }
        ...
        public void setPathData(final android.support.v4.c.b.b[] array) {
            if (!android.support.v4.c.b.a(this.m, array)) {
                this.m = android.support.v4.c.b.a(array);
                return;
            }
            android.support.v4.c.b.b(this.m, array);
        }
    }
    ...
    private static class e
    {
        ...
        public e() {
            ...
            this.f = 255;
            this.g = null;
            this.h = new android.support.v4.g.a<String, Object>();
            this.a = new c();
            this.i = new Path();
            this.j = new Path();
        }
        ...
        private void a(final c c, final d d, final Canvas canvas, final int n, final int n2, final ColorFilter colorFilter) {
            ...
            if (a2 != 0.0f) {
                ...
                if (b.c != 0) {
                    ...
                    n7.setColor(android.support.b.a.i.a(b.c, b.f));
                ...
                if (b.a != 0) {
                    ...
                    m.setColor(android.support.b.a.i.a(b.a, b.d));
        ...
        public void a(final Canvas canvas, final int n, final int n2, final ColorFilter colorFilter) {
            this.a(this.a, android.support.b.a.i.e.k, canvas, n, n2, colorFilter);
        }
    ...
    private static class g extends Drawable$ConstantState
    {
        ...
        public Drawable newDrawable() {
            final i i = new i();
            i.b = this.a.newDrawable();
            return i;
        }
        
        public Drawable newDrawable(final Resources resources) {
            final i i = new i();
            i.b = this.a.newDrawable(resources);
            return i;
        }
        
        public Drawable newDrawable(final Resources resources, final Resources$Theme resources$Theme) {
            final i i = new i();
            i.b = this.a.newDrawable(resources, resources$Theme);
            return i;
        }
    }
}
