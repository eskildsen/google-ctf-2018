...
class aq extends j implements View$OnClickListener
{
    ...
    public aq(final Context m, final SearchView k, final SearchableInfo l, final WeakHashMap<String, Drawable$ConstantState> n) {
    ...
    private Drawable b(final Uri p0) {
        ...
        //    15: aload_0        
        //    16: aload_1        
        //    17: invokevirtual   android/support/v7/widget/aq.a:(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
        //    20: astore_3       
        //    21: aload_3        
        //    22: areturn        
        //    23: astore_3       
        ...
        //    93: areturn        
        //    94: aload_0        
        //    95: getfield        android/support/v7/widget/aq.m:Landroid/content/Context;
    ...
    public View getDropDownView(final int n, View dropDownView, final ViewGroup viewGroup) {
        try {
            ...
            final View b = this.b(this.d, this.c, viewGroup);
            if (b != null) {
                ((a)b.getTag()).a.setText((CharSequence)ex.toString());
            }
            return b;
        }
    }
