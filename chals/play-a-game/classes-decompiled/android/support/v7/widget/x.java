...
public class x extends Spinner implements o
{
    ...
    public x(final Context p0, final AttributeSet p1, final int p2, final int p3, final Resources$Theme p4) {
        ...
        //    15: putfield        android/support/v7/widget/x.i:Landroid/graphics/Rect;
        //    18: aload_1        
        //    19: aload_2        
        //    20: getstatic       android/support/v7/a/a$j.Spinner:[I
        //    23: iload_3        
        //    24: iconst_0       
        //    25: invokestatic    android/support/v7/widget/aw.a:(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/aw;
        //    28: astore          10
        //    30: aload_0        
        ...
        //    39: putfield        android/support/v7/widget/x.b:Landroid/support/v7/widget/g;
        //    42: aload           5
        //    44: ifnull          329
        //    47: aload_0        
        ...
        //    58: putfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //    61: aload_0        
        //    62: getfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //    65: ifnull          249
        //    68: iload           4
        //    70: istore          7
        //    72: iload           4
        ...
        //    86: aload_1        
        //    87: aload_2        
        //    88: getstatic       android/support/v7/widget/x.a:[I
        //    91: iload_3        
        //    92: iconst_0       
        ...
        //   156: aload_0        
        //   157: aload_0        
        //   158: getfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //   161: aload_2        
        //   162: iload_3        
        ...
        //   166: astore          5
        //   168: aload_0        
        //   169: getfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //   172: aload_2        
        //   173: getstatic       android/support/v7/a/a$j.Spinner:[I
        //   176: iload_3        
        //   177: iconst_0       
        //   178: invokestatic    android/support/v7/widget/aw.a:(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/aw;
        //   181: astore          8
        //   183: aload_0        
        //   184: aload           8
        //   186: getstatic       android/support/v7/a/a$j.Spinner_android_dropDownWidth:I
        //   189: bipush          -2
        //   191: invokevirtual   android/support/v7/widget/aw.f:(II)I
        //   194: putfield        android/support/v7/widget/x.h:I
        //   197: aload           5
        //   199: aload           8
        //   201: getstatic       android/support/v7/a/a$j.Spinner_android_popupBackground:I
        //   204: invokevirtual   android/support/v7/widget/aw.a:(I)Landroid/graphics/drawable/Drawable;
        ...
        //   217: invokevirtual   android/support/v7/widget/aw.d:(I)Ljava/lang/String;
        //   220: invokevirtual   android/support/v7/widget/x$b.a:(Ljava/lang/CharSequence;)V
        //   223: aload           8
        //   225: invokevirtual   android/support/v7/widget/aw.a:()V
        //   228: aload_0        
        //   229: aload           5
        //   231: putfield        android/support/v7/widget/x.g:Landroid/support/v7/widget/x$b;
        //   234: aload_0        
        ...
        //   246: putfield        android/support/v7/widget/x.d:Landroid/support/v7/widget/ah;
        //   249: aload           10
        //   251: getstatic       android/support/v7/a/a$j.Spinner_android_entries:I
        //   254: invokevirtual   android/support/v7/widget/aw.f:(I)[Ljava/lang/CharSequence;
        //   257: astore          5
        //   259: aload           5
        //   261: ifnull          289
        ...
        //   289: aload           10
        //   291: invokevirtual   android/support/v7/widget/aw.a:()V
        //   294: aload_0        
        //   295: iconst_1       
        //   296: putfield        android/support/v7/widget/x.f:Z
        //   299: aload_0        
        //   300: getfield        android/support/v7/widget/x.e:Landroid/widget/SpinnerAdapter;
        //   303: ifnull          319
        //   306: aload_0        
        //   307: aload_0        
        //   308: getfield        android/support/v7/widget/x.e:Landroid/widget/SpinnerAdapter;
        //   311: invokevirtual   android/support/v7/widget/x.setAdapter:(Landroid/widget/SpinnerAdapter;)V
        //   314: aload_0        
        //   315: aconst_null    
        //   316: putfield        android/support/v7/widget/x.e:Landroid/widget/SpinnerAdapter;
        //   319: aload_0        
        //   320: getfield        android/support/v7/widget/x.b:Landroid/support/v7/widget/g;
        //   323: aload_2        
        //   324: iload_3        
        ...
        //   334: iconst_0       
        //   335: invokevirtual   android/support/v7/widget/aw.g:(II)I
        //   338: istore          6
        //   340: iload           6
        //   342: ifeq            362
        //   345: aload_0        
        ...
        //   356: putfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //   359: goto            61
        ...
        //   373: aload_0        
        //   374: aload           5
        //   376: putfield        android/support/v7/widget/x.c:Landroid/content/Context;
        //   379: goto            61
        //   382: aconst_null    
        //   383: astore          5
        //   385: goto            373
    ...
    int a(final SpinnerAdapter spinnerAdapter, final Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            return this.i.left + this.i.right + max2;
        }
        return max2;
    }
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        if (this.g != null && View$MeasureSpec.getMode(n) == Integer.MIN_VALUE) {
    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        return (this.d != null && this.d.onTouch((View)this, motionEvent)) || super.onTouchEvent(motionEvent);
    }
    ...
    public void setDropDownHorizontalOffset(final int dropDownHorizontalOffset) {
        if (this.g != null) {
            this.g.c(dropDownHorizontalOffset);
        }
    ...
    public void setDropDownVerticalOffset(final int dropDownVerticalOffset) {
        if (this.g != null) {
            this.g.d(dropDownVerticalOffset);
        }
        else if (Build$VERSION.SDK_INT >= 16) {
    ...
    public void setPopupBackgroundDrawable(final Drawable popupBackgroundDrawable) {
        if (this.g != null) {
            this.g.a(popupBackgroundDrawable);
        }
        else if (Build$VERSION.SDK_INT >= 16) {
    ...
    private class b extends aj
    {
        ...
        boolean a(final View view) {
            return android.support.v4.h.p.m(view) && view.getGlobalVisibleRect(this.i);
        }
        ...
        void f() {
            ...
            int right;
            if (h != null) {
                h.getPadding(x.this.i);
                if (bc.a((View)x.this)) {
                    right = x.this.i.right;
                }
                else {
                    right = -x.this.i.left;
                }
            ...
            if (x.this.h == -2) {
                ...
                final int n = x.this.getContext().getResources().getDisplayMetrics().widthPixels - x.this.i.left - x.this.i.right;
                if (a > n) {
                    a = n;
                }
