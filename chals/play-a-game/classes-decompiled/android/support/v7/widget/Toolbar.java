...
public class Toolbar extends ViewGroup
{
    ...
    public Toolbar(final Context context, final AttributeSet set, int n) {
        ...
        final aw a = aw.a(this.getContext(), set, android.support.v7.a.a.j.Toolbar, n, 0);
    ...
    private void a(final List<View> list, int i) {
        int n = 1;
        final int n2 = 0;
        if (android.support.v4.h.p.b((View)this) != 1) {
            n = 0;
        }
        final int childCount = this.getChildCount();
        final int a = android.support.v4.h.d.a(i, android.support.v4.h.p.b((View)this));
        list.clear();
        i = n2;
        if (n != 0) {
            View child;
    ...
    private int b(int n) {
        final int b = android.support.v4.h.p.b((View)this);
        switch (n = (android.support.v4.h.d.a(n, b) & 0x7)) {
            default: {
                if (b == 1) {
                    n = 5;
                    return n;
    ...
    private int b(final View view) {
        final ViewGroup$MarginLayoutParams viewGroup$MarginLayoutParams = (ViewGroup$MarginLayoutParams)view.getLayoutParams();
        return android.support.v4.h.f.b(viewGroup$MarginLayoutParams) + android.support.v4.h.f.a(viewGroup$MarginLayoutParams);
    }
    ...
    protected void onLayout(final boolean b, int i, int j, int n, int n2) {
        ...
        final int[] g = this.G;
        g[g[1] = 0] = 0;
        n = android.support.v4.h.p.c((View)this);
        int min;
        if (n >= 0) {
            min = Math.min(n, n2 - j);
        }
    ...
    protected void onMeasure(int resolveSizeAndState, final int n) {
        ...
        int n4 = 0;
        if (this.a((View)this.h)) {
            this.a((View)this.h, resolveSizeAndState, 0, n, 0, this.p);
        ...
        int max2 = max;
        if (this.a((View)this.a)) {
            this.a((View)this.a, resolveSizeAndState, 0, n, 0, this.p);
            n5 = this.a.getMeasuredWidth() + this.b((View)this.a);
            max2 = Math.max(max, this.a.getMeasuredHeight() + this.c((View)this.a));
            combineMeasuredStates2 = View.combineMeasuredStates(combineMeasuredStates, this.a.getMeasuredState());
        }
        ...
        int max3 = max2;
        if (this.a((View)this.e)) {
            this.a((View)this.e, resolveSizeAndState, n6, n, 0, this.p);
            n7 = this.e.getMeasuredWidth() + this.b((View)this.e);
            max3 = Math.max(max2, this.e.getMeasuredHeight() + this.c((View)this.e));
            combineMeasuredStates3 = View.combineMeasuredStates(combineMeasuredStates2, this.e.getMeasuredState());
        }
        ...
        int max4 = max3;
        if (this.a(this.b)) {
            n9 = n8 + this.a(this.b, resolveSizeAndState, n8, n, 0, g);
            max4 = Math.max(max3, this.b.getMeasuredHeight() + this.c(this.b));
            combineMeasuredStates4 = View.combineMeasuredStates(combineMeasuredStates3, this.b.getMeasuredState());
        }
        int n10 = n9;
        int combineMeasuredStates5 = combineMeasuredStates4;
        int max5 = max4;
        if (this.a((View)this.i)) {
            n10 = n9 + this.a((View)this.i, resolveSizeAndState, n9, n, 0, g);
            max5 = Math.max(max4, this.i.getMeasuredHeight() + this.c((View)this.i));
            combineMeasuredStates5 = View.combineMeasuredStates(combineMeasuredStates4, this.i.getMeasuredState());
        }
        final int childCount = this.getChildCount();
        final int n11 = 0;
        int max6 = max5;
        ...
        while (i < childCount) {
            ...
            if (((b)child.getLayoutParams()).b == 0) {
                if (this.a(child)) {
                    n12 += this.a(child, resolveSizeAndState, n12, n, 0, g);
                    max6 = Math.max(max6, child.getMeasuredHeight() + this.c(child));
                    combineMeasuredStates6 = View.combineMeasuredStates(combineMeasuredStates6, child.getMeasuredState());
                }
            }
            ++i;
        }
        ...
        if (this.a((View)this.f)) {
            this.a((View)this.f, resolveSizeAndState, n12 + n16, n, n15, g);
            n13 = this.b((View)this.f) + this.f.getMeasuredWidth();
            n14 = this.f.getMeasuredHeight() + this.c((View)this.f);
            combineMeasuredStates7 = View.combineMeasuredStates(combineMeasuredStates6, this.f.getMeasuredState());
        }
        int n17 = n14;
        int max7 = n13;
        int combineMeasuredStates8 = combineMeasuredStates7;
        if (this.a((View)this.g)) {
            max7 = Math.max(n13, this.a((View)this.g, resolveSizeAndState, n12 + n16, n, n15 + n14, g));
            n17 = n14 + (this.g.getMeasuredHeight() + this.c((View)this.g));
            combineMeasuredStates8 = View.combineMeasuredStates(combineMeasuredStates7, this.g.getMeasuredState());
        }
        ...
        final int paddingTop = this.getPaddingTop();
        final int paddingBottom = this.getPaddingBottom();
        final int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(max7 + n12 + (paddingLeft + paddingRight), this.getSuggestedMinimumWidth()), resolveSizeAndState, 0xFF000000 & combineMeasuredStates8);
    ...
    public static class d extends android.support.v4.h.a
    {
        ...
        static {
            CREATOR = (Parcelable$Creator)new Parcelable$ClassLoaderCreator<d>() {
                ...
                public d a(final Parcel parcel, final ClassLoader classLoader) {
