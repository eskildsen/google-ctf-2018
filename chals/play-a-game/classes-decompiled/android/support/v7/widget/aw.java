...
public class aw
{
    ...
    private aw(final Context a, final TypedArray b) {
        this.a = a;
        this.b = b;
    }
    
    public static aw a(final Context context, final int n, final int[] array) {
        return new aw(context, context.obtainStyledAttributes(n, array));
    }
    
    public static aw a(final Context context, final AttributeSet set, final int[] array) {
        return new aw(context, context.obtainStyledAttributes(set, array));
    }
    
    public static aw a(final Context context, final AttributeSet set, final int[] array, final int n, final int n2) {
        return new aw(context, context.obtainStyledAttributes(set, array, n, n2));
    }
    ...
    public Typeface a(int resourceId, final int n, final TextView textView) {
        ...
        return android.support.v4.b.a.b.a(this.a, resourceId, this.c, n, textView);
    }
