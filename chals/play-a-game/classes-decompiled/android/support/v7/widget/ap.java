...
public class ap extends HorizontalScrollView implements AdapterView$OnItemSelectedListener
{
    ...
    private Spinner d() {
        ...
        x.setLayoutParams((ViewGroup$LayoutParams)new ai.a(-2, -1));
    ...
    public void a(final int n) {
        ...
        this.post(this.a = new Runnable() {
            @Override
            public void run() {
                ap.this.smoothScrollTo(child.getLeft() - (ap.this.getWidth() - child.getWidth()) / 2, 0);
                ap.this.a = null;
            }
        });
    }
    ...
    private class a extends BaseAdapter
    {
        ...
        public Object getItem(final int n) {
            return ((c)ap.this.b.getChildAt(n)).b();
        }
        ...
        public View getView(final int n, final View view, final ViewGroup viewGroup) {
            if (view == null) {
                return (View)ap.this.a((android.support.v7.app.a.c)this.getItem(n), true);
            }
    ...
    private class b implements View$OnClickListener
    {
        public void onClick(final View view) {
            ((c)view).b().d();
            for (int childCount = ap.this.b.getChildCount(), i = 0; i < childCount; ++i) {
                final View child = ap.this.b.getChildAt(i);
    ...
    private class c extends ai
    {
        ...
        public c(final Context context, final android.support.v7.app.a.c c, final boolean b) {
            ...
            this.c = c;
            final aw a2 = aw.a(context, null, this.b, android.support.v7.a.a.a.actionBarTabStyle, 0);
            if (a2.g(0)) {
        ...
        public void a() {
            ...
            if (a != null) {
                if (this.e == null) {
                    ...
                    final ai.a layoutParams = new ai.a(-2, -2);
                    layoutParams.h = 16;
            ...
            if (b2) {
                if (this.d == null) {
                    ...
                    final ai.a layoutParams2 = new ai.a(-2, -2);
                    layoutParams2.h = 16;
        ...
        public void onMeasure(final int n, final int n2) {
            ...
            if (ap.this.c > 0 && this.getMeasuredWidth() > ap.this.c) {
                super.onMeasure(View$MeasureSpec.makeMeasureSpec(ap.this.c, 1073741824), n2);
            }
        }
