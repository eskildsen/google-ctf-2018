...
public class AlertDialogLayout extends ai
{
    ...
    private boolean c(final int n, final int n2) {
        ...
        this.setMeasuredDimension(View.resolveSizeAndState(n11 + (this.getPaddingLeft() + this.getPaddingRight()), n, combineMeasuredStates2), View.resolveSizeAndState(n10, n2, 0));
        if (mode2 != 1073741824) {
        ...
        for (i = 0; i < childCount; ++i, n = h) {
            ...
            if (child != null) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    switch (android.support.v4.h.d.a(h, p.b((View)this)) & 0x7) {
                        default: {
