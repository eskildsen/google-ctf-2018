...
class w extends s
{
    ...
    void a(final Drawable b) {
        ...
        if ((this.b = b) != null) {
            ...
            android.support.v4.c.a.a.b(b, p.b((View)this.a));
            if (b.isStateful()) {
    ...
    void a(final AttributeSet set, final int n) {
        super.a(set, n);
        final aw a = aw.a(this.a.getContext(), set, android.support.v7.a.a.j.AppCompatSeekBar, n, 0);
        ...
        if (a.g(android.support.v7.a.a.j.AppCompatSeekBar_tickMarkTintMode)) {
            this.d = ae.a(a.a(android.support.v7.a.a.j.AppCompatSeekBar_tickMarkTintMode, -1), this.d);
            this.f = true;
        }
