...
public class ax implements ad
{
    ...
    public ax(final Toolbar a, final boolean b, final int n, int n2) {
        ...
        final aw a2 = aw.a(a.getContext(), null, android.support.v7.a.a.j.ActionBar, android.support.v7.a.a.a.actionBarStyle, 0);
        ...
        this.a.setNavigationOnClickListener((View$OnClickListener)new View$OnClickListener() {
            ...
            public void onClick(final View view) {
                if (ax.this.c != null && ax.this.d) {
                    ax.this.c.onMenuItemSelected(0, (MenuItem)this.a);
                }
            }
        });
    }
    ...
    @Override
    public r a(final int n, final long n2) {
        final r d = android.support.v4.h.p.d((View)this.a);
        float n3;
        if (n == 0) {
            n3 = 1.0f;
        }
