...
public class k extends android.support.v7.view.menu.c<android.support.v4.d.a.b> implements MenuItem
{
    ...
    public ActionProvider getActionProvider() {
        final android.support.v4.h.c a = ((android.support.v4.d.a.b)this.b).a();
        if (a instanceof a) {
            return ((a)a).a;
        }
        return null;
    ...
    public MenuItem setAlphabeticShortcut(final char c, final int n) {
        ((android.support.v4.d.a.b)this.b).setAlphabeticShortcut(c, n);
        return (MenuItem)this;
    }
    ...
    public MenuItem setContentDescription(final CharSequence charSequence) {
    ...
    public MenuItem setIconTintList(final ColorStateList iconTintList) {
        ((android.support.v4.d.a.b)this.b).setIconTintList(iconTintList);
        return (MenuItem)this;
    }
    
    public MenuItem setIconTintMode(final PorterDuff$Mode iconTintMode) {
        ((android.support.v4.d.a.b)this.b).setIconTintMode(iconTintMode);
        return (MenuItem)this;
    }
    ...
    public MenuItem setNumericShortcut(final char c, final int n) {
        ((android.support.v4.d.a.b)this.b).setNumericShortcut(c, n);
        return (MenuItem)this;
    }
    ...
    public MenuItem setOnActionExpandListener(final MenuItem$OnActionExpandListener menuItem$OnActionExpandListener) {
        ...
        if (menuItem$OnActionExpandListener != null) {
            onActionExpandListener = new c(menuItem$OnActionExpandListener);
        }
        else {
            onActionExpandListener = null;
        }
        b.setOnActionExpandListener((MenuItem$OnActionExpandListener)onActionExpandListener);
        return (MenuItem)this;
    }
    ...
    public MenuItem setShortcut(final char c, final char c2, final int n, final int n2) {
        ((android.support.v4.d.a.b)this.b).setShortcut(c, c2, n, n2);
        return (MenuItem)this;
    }
    ...
    public MenuItem setTooltipText(final CharSequence charSequence) {
