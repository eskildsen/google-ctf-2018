...
class AlertController
{
    ...
    private void a(final ViewGroup viewGroup, View view, final int n, final int n2) {
        ...
        if (Build$VERSION.SDK_INT >= 23) {
            android.support.v4.h.p.a(view, n, n2);
            if (viewById != null) {
    ...
    private void c() {
        ...
        final boolean b = a != null && a.getVisibility() != 8;
        final boolean b2 = a3 != null && a3.getVisibility() != 8;
        if (!b2 && a2 != null) {
        ...
        if (n == 0) {
            ...
            if (o != null) {
                ...
                this.a(a2, (View)o, n2 | (b3 ? 1 : 0), 3);
            }
        }
        final ListView b4 = this.b;
        if (b4 != null && this.j != null) {
            b4.setAdapter(this.j);
            final int k = this.k;
            if (k > -1) {
                b4.setItemChecked(k, true);
                b4.setSelection(k);
            }
        }
    }
