...
class q
{
    ...
    private Location b() {
        Location a = null;
        Location a2;
        if (android.support.v4.b.c.a(this.b, "android.permission.ACCESS_COARSE_LOCATION") == 0) {
            a2 = this.a("network");
        }
        else {
            a2 = null;
        }
        if (android.support.v4.b.c.a(this.b, "android.permission.ACCESS_FINE_LOCATION") == 0) {
            a = this.a("gps");
        }
        if (a != null && a2 != null) {
