...
class m
{
    ...
    static {
        ...
        d = new android.support.v4.g.a<String, Constructor<? extends View>>();
    }
    ...
    private void a(final View view, final AttributeSet set) {
        ...
        if (!(context instanceof ContextWrapper) || (Build$VERSION.SDK_INT >= 15 && !p.n(view))) {
            return;
        }
    ...
    public final View a(View a, final String s, final Context context, final AttributeSet set, final boolean b, final boolean b2, final boolean b3, final boolean b4) {
        ...
        switch (s) {
            ...
            case "ImageView": {
                a = new android.support.v7.widget.p(a3, set);
                break;
            }
            case "Button": {
                a = new h(a3, set);
