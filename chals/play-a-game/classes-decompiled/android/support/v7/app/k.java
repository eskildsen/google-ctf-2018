...
class k extends f implements h.a, LayoutInflater$Factory2
{
    ...
    private boolean a(ViewParent parent) {
        ...
        while (parent != null) {
            if (parent == decorView || !(parent instanceof View) || android.support.v4.h.p.m((View)parent)) {
                return false;
            }
    ...
    private void d(final int n) {
        this.s |= 1 << n;
        if (!this.r) {
            android.support.v4.h.p.a(this.b.getDecorView(), this.H);
            this.r = true;
        }
    }
    ...
    private boolean e(final int n, final KeyEvent keyEvent) {
        ...
        while (true) {
            Label_0229: {
                boolean b2;
                if (n == 0 && this.u != null && this.u.e() && !ViewConfiguration.get(this.a).hasPermanentMenuKey()) {
                    if (!this.u.f()) {
    ...
    private ViewGroup x() {
        ...
        if (!this.l) {
            if (this.k) {
                ...
                (this.u = (ac)contentView.findViewById(android.support.v7.a.a.f.decor_content_parent)).setWindowCallback(this.q());
                if (this.i) {
                    this.u.a(109);
                }
                if (this.B) {
            ...
            if (Build$VERSION.SDK_INT >= 21) {
                android.support.v4.h.p.a((View)contentView, new n() {
                    @Override
                    public v a(final View view, final v v) {
                        ...
                        return android.support.v4.h.p.a(view, a);
                    }
                });
            }
            else {
                ((ag)contentView).setOnFitSystemWindowsListener((ag.a)new ag.a() {
                    @Override
                ...
                while (true) {
                    ...
                    if (this.n == null) {
                        if (this.k) {
                            ...
                            i.a(this.o = new PopupWindow((Context)a4, (AttributeSet)null, a.a.actionModePopupWindowStyle), 2);
                            ...
                            this.p = new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (k.this.s()) {
                                        ...
                                        (k.this.q = android.support.v4.h.p.d((View)k.this.n).a(1.0f)).a(new t() {
                                            @Override
                    ...
                    if (this.s()) {
                        ...
                        (this.q = android.support.v4.h.p.d((View)this.n).a(1.0f)).a(new t() {
                            @Override
                            public void a(final View view) {
                                k.this.n.setVisibility(0);
                                k.this.n.sendAccessibilityEvent(32);
                                if (k.this.n.getParent() instanceof View) {
                                    android.support.v4.h.p.g((View)k.this.n.getParent());
                                }
                            }
                        ...
                        if (this.n.getParent() instanceof View) {
                            android.support.v4.h.p.g((View)this.n.getParent());
                        }
                    }
                    if (this.o != null) {
    ...
    public <T extends View> T a(final int n) {
        this.w();
        return (T)this.b.findViewById(n);
    }
    
    View a(View onCreateView, final String s, final Context context, final AttributeSet set) {
    ...
    public void a(final Bundle bundle) {
        if (this.c instanceof Activity && android.support.v4.a.w.b((Activity)this.c) != null) {
    ...
    public View b(final View view, final String s, final Context context, final AttributeSet set) {
        if (this.L == null) {
            this.L = new m();
        }
        boolean a;
        ...
        return this.L.a(view, s, context, set, a, k.t, true, bb.a());
    }
    ...
    public void h() {
        ...
        if (from.getFactory() == null) {
            android.support.v4.h.e.b(from, (LayoutInflater$Factory2)this);
        }
    ...
    public void l() {
        ...
        if (this.h && this.f == null) {
            if (this.c instanceof Activity) {
                this.f = new android.support.v7.app.r((Activity)this.c, this.i);
            }
            else if (this.c instanceof Dialog) {
                this.f = new android.support.v7.app.r((Dialog)this.c);
            }
            if (this.f != null) {
                this.f.c(this.I);
            }
    ...
    public final View onCreateView(final View view, final String s, final Context context, final AttributeSet set) {
        final View a = this.a(view, s, context, set);
        if (a != null) {
            return a;
        }
        return this.b(view, s, context, set);
    }
    ...
    final boolean s() {
        return this.x && this.y != null && android.support.v4.h.p.l((View)this.y);
    }
    ...
    class b implements android.support.v7.view.b.a
    {
        ...
        public void a(final android.support.v7.view.b b) {
            ...
            if (k.this.n != null) {
                k.this.t();
                (k.this.q = android.support.v4.h.p.d((View)k.this.n).a(0.0f)).a(new t() {
                    @Override
                    public void b(final View view) {
    ...
    protected static final class d
    {
        ...
        android.support.v7.view.menu.p a(final android.support.v7.view.menu.o.a a) {
            if (this.j == null) {
                return null;
            }
            if (this.k == null) {
