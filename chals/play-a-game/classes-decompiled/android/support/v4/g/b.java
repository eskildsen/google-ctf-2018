...
public final class b<E> implements Collection<E>, Set<E>
{
    ...
    public b(final int n, final boolean e) {
        this.e = e;
        if (n == 0) {
            this.f = android.support.v4.g.b.j;
            this.g = android.support.v4.g.b.k;
        }
        else {
            this.d(n);
        }
    ...
    private int a() {
        ...
        if (h == 0) {
            ...
            final int a = android.support.v4.g.c.a(this.f, h, 0);
            if ((n = a) >= 0) {
                n = a;
                if (this.g[a] != null) {
                    int n2;
    ...
    private int a(final Object o, final int n) {
        ...
        if (h == 0) {
            ...
            final int a = android.support.v4.g.c.a(this.f, h, n);
            if ((n2 = a) >= 0) {
                n2 = a;
        ...
        while (true) {
            Label_0035: {
                ...
                synchronized (b.class) {
                    if (android.support.v4.g.b.d < 10) {
                        array2[0] = android.support.v4.g.b.c;
                        array2[1] = array;
                        --i;
                        continue Label_0113;
                    }
                    return;
                    android.support.v4.g.b.c = array2;
                    ++android.support.v4.g.b.d;
                    return;
                }
            }
            if (array.length != 4) {
            ...
            while (true) {
                while (true) {
                    Label_0130: {
                        synchronized (b.class) {
                            if (android.support.v4.g.b.b < 10) {
                                array2[0] = android.support.v4.g.b.a;
                                array2[1] = array;
                                --i;
                                break Label_0130;
                            }
                            return;
                            android.support.v4.g.b.a = array2;
                            ++android.support.v4.g.b.b;
                            return;
                        }
                        continue Label_0113;
                    }
    ...
    private void d(final int n) {
        while (true) {
            Label_0094: {
                ...
                synchronized (b.class) {
                    if (android.support.v4.g.b.c != null) {
                        final Object[] c = android.support.v4.g.b.c;
                        this.g = c;
                        android.support.v4.g.b.c = (Object[])c[0];
                        this.f = (int[])c[1];
                        c[0] = (c[1] = null);
                        --android.support.v4.g.b.d;
                        return;
            ...
            if (n == 4) {
                synchronized (b.class) {
                    if (android.support.v4.g.b.a != null) {
                        final Object[] a = android.support.v4.g.b.a;
                        this.g = a;
                        android.support.v4.g.b.a = (Object[])a[0];
                        this.f = (int[])a[1];
                        a[0] = (a[1] = null);
                        --android.support.v4.g.b.b;
                        return;
