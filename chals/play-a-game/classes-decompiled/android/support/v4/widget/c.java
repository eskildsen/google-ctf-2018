...
public abstract class c extends BaseAdapter implements d.a, Filterable
{
    ...
    public c(final Context context, final Cursor cursor, final boolean b) {
        int n;
        if (b) {
            n = 1;
        }
    ...
    private class a extends ContentObserver
    {
        ...
        public void onChange(final boolean b) {
            android.support.v4.widget.c.this.b();
        }
    }
    ...
    private class b extends DataSetObserver
    {
        public void onChanged() {
            android.support.v4.widget.c.this.a = true;
            android.support.v4.widget.c.this.notifyDataSetChanged();
        }
        
        public void onInvalidated() {
            android.support.v4.widget.c.this.a = false;
            android.support.v4.widget.c.this.notifyDataSetInvalidated();
        }
    }
}
