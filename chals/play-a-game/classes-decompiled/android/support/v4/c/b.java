...
public class b
{
    ...
    public static Path a(final String s) {
        final Path path = new Path();
        final b[] b = b(s);
        if (b != null) {
            try {
                android.support.v4.c.b.b.a(b, path);
                return path;
            }
    ...
    private static float[] c(final String s) {
        int n = 0;
    ...
    public static class b
    {
        ...
        b(final b b) {
            this.a = b.a;
            this.b = android.support.v4.c.b.a(b.b, 0, b.b.length);
        }
        ...
        public void a(final b b, final b b2, final float n) {
            for (int i = 0; i < b.b.length; ++i) {
                this.b[i] = b.b[i] * (1.0f - n) + b2.b[i] * n;
            }
        }
    }
}
