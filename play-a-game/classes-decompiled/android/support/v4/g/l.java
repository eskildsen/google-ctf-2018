...
public class l<E> implements Cloneable
{
    ...
    public l(int a) {
        this.b = false;
        if (a == 0) {
            this.c = android.support.v4.g.c.a;
            this.d = android.support.v4.g.c.c;
        }
        else {
            a = android.support.v4.g.c.a(a);
            this.c = new int[a];
            this.d = new Object[a];
        }
        this.e = 0;
    ...
    public E a(int a, final E e) {
        a = android.support.v4.g.c.a(this.c, this.e, a);
        if (a < 0 || this.d[a] == l.a) {
            return e;
        }
        return (E)this.d[a];
    ...
    public void b(final int n, final E e) {
        final int a = android.support.v4.g.c.a(this.c, this.e, n);
        if (a >= 0) {
            this.d[a] = e;
            return;
        }
        final int n2 = ~a;
        if (n2 < this.e && this.d[n2] == l.a) {
            this.c[n2] = n;
            this.d[n2] = e;
            return;
        }
        ...
        if (this.b) {
            ...
            if (this.e >= this.c.length) {
                this.d();
                n3 = ~android.support.v4.g.c.a(this.c, this.e, n);
            }
        }
        if (this.e >= this.c.length) {
            final int a2 = android.support.v4.g.c.a(this.e + 1);
    ...
    public void c(final int n, final E e) {
        ...
        final int e2 = this.e;
        if (e2 >= this.c.length) {
            final int a = android.support.v4.g.c.a(e2 + 1);
