...
public final class l
{
    ...
    private Drawable a(final Context context, final int n, final boolean b, final Drawable drawable) {
        ...
        if (b2 != null) {
            ...
            if (n == android.support.v7.a.a.e.abc_seekbar_track_material) {
                ...
                a(layerDrawable.findDrawableByLayerId(16908288), ar.a(context, android.support.v7.a.a.a.colorControlNormal), android.support.v7.widget.l.a);
                a(layerDrawable.findDrawableByLayerId(16908303), ar.a(context, android.support.v7.a.a.a.colorControlNormal), android.support.v7.widget.l.a);
                a(layerDrawable.findDrawableByLayerId(16908301), ar.a(context, android.support.v7.a.a.a.colorControlActivated), android.support.v7.widget.l.a);
                return drawable;
            }
            if (n == android.support.v7.a.a.e.abc_ratingbar_material || n == android.support.v7.a.a.e.abc_ratingbar_indicator_material || n == android.support.v7.a.a.e.abc_ratingbar_small_material) {
                ...
                a(layerDrawable2.findDrawableByLayerId(16908288), ar.c(context, android.support.v7.a.a.a.colorControlNormal), android.support.v7.widget.l.a);
                a(layerDrawable2.findDrawableByLayerId(16908303), ar.a(context, android.support.v7.a.a.a.colorControlActivated), android.support.v7.widget.l.a);
                a(layerDrawable2.findDrawableByLayerId(16908301), ar.a(context, android.support.v7.a.a.a.colorControlActivated), android.support.v7.widget.l.a);
                return drawable;
            }
            drawable2 = drawable;
    ...
    private void a(final Context context, final int n, final ColorStateList list) {
        if (this.j == null) {
            this.j = new WeakHashMap<Context, android.support.v4.g.l<ColorStateList>>();
        }
        android.support.v4.g.l<ColorStateList> l;
        if ((l = this.j.get(context)) == null) {
            l = new android.support.v4.g.l<ColorStateList>();
            this.j.put(context, l);
        }
        l.c(n, list);
    }
    ...
    static void a(final Drawable drawable, final au au, final int[] array) {
    ...
    private void a(final String s, final c c) {
        if (this.k == null) {
            this.k = new android.support.v4.g.a<String, c>();
        }
        this.k.put(s, c);
    }
    ...
    static boolean a(final Context context, int round, final Drawable drawable) {
        ...
        if (n2 != 0) {
            ...
            mutate.setColorFilter((ColorFilter)a(ar.a(context, n), porterDuff$Mode));
            if (round != -1) {
    ...
    private ColorStateList b(final Context context) {
        return this.f(context, ar.a(context, android.support.v7.a.a.a.colorButtonNormal));
    }
    ...
    private ColorStateList d(final Context context) {
        return this.f(context, ar.a(context, android.support.v7.a.a.a.colorAccent));
    }
    ...
    private Drawable d(final Context context, final int n) {
        ...
        Label_0082: {
            if (this.l == null) {
                this.l = new android.support.v4.g.l<String>();
                break Label_0082;
            }
    ...
    private ColorStateList e(final Context context) {
        final int[][] array = new int[3][];
        final int[] array2 = new int[3];
        final ColorStateList b = ar.b(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
        if (b != null && b.isStateful()) {
            array[0] = ar.a;
            array2[0] = b.getColorForState(array[0], 0);
            array[1] = ar.e;
            array2[1] = ar.a(context, android.support.v7.a.a.a.colorControlActivated);
            array[2] = ar.h;
            array2[2] = b.getDefaultColor();
        }
        else {
            array[0] = ar.a;
            array2[0] = ar.c(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
            array[1] = ar.e;
            array2[1] = ar.a(context, android.support.v7.a.a.a.colorControlActivated);
            array[2] = ar.h;
            array2[2] = ar.a(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
        }
    ...
    private ColorStateList e(final Context context, final int n) {
        ...
        final android.support.v4.g.l<ColorStateList> l = this.j.get(context);
        if (l != null) {
            return l.a(n);
        }
        return null;
    ...
    private ColorStateList f(final Context context, final int n) {
        final int a = ar.a(context, android.support.v7.a.a.a.colorControlHighlight);
        return new ColorStateList(new int[][] { ar.a, ar.d, ar.b, ar.h }, new int[] { ar.c(context, android.support.v7.a.a.a.colorButtonNormal), android.support.v4.c.a.a(a, n), android.support.v4.c.a.a(a, n), n });
    }
    ...
    Drawable a(final Context context, final bb bb, final int n) {
        Drawable drawable;
        if ((drawable = this.d(context, n)) == null) {
            drawable = bb.a(n);
        }
    ...
    ColorStateList b(final Context context, final int n) {
        ...
        if (list == null) {
            if (n == android.support.v7.a.a.e.abc_edit_text_material) {
                ...
                list = ar.b(context, android.support.v7.a.a.a.colorControlNormal);
            }
    ...
    private static class d implements c
    {
        ...
        public Drawable a(final Context context, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) {
            try {
                return android.support.b.a.i.a(context.getResources(), xmlPullParser, set, resources$Theme);
            }
            catch (Exception ex) {
