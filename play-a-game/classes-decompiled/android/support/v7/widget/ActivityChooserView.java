...
public class ActivityChooserView extends ViewGroup
{
    ...
    void a(final int n) {
        ...
        final aj listPopupWindow = this.getListPopupWindow();
        if (!listPopupWindow.d()) {
            ...
            listPopupWindow.e().setSelector((Drawable)new ColorDrawable(0));
        }
    }
    ...
    aj getListPopupWindow() {
        if (this.n == null) {
            (this.n = new aj(this.getContext())).a((ListAdapter)this.a);
            this.n.b((View)this);
            this.n.a(true);
    ...
    public void setActivityChooserModel(final e e) {
        this.a.a(e);
        if (this.c()) {
            this.b();
            this.a();
    ...
    public void setProvider(final c d) {
        this.d = d;
    }
    ...
    public static class InnerLayout extends ai
    {
        ...
        public InnerLayout(final Context context, final AttributeSet set) {
            super(context, set);
            final aw a = aw.a(context, set, InnerLayout.a);
