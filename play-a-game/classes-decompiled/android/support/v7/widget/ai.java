...
public class ai extends ViewGroup
{
    ...
    public ai(final Context context, final AttributeSet set, int n) {
        super(context, set, n);
        this.a = true;
        this.b = -1;
        this.c = 0;
        this.e = 8388659;
        final aw a = aw.a(context, set, android.support.v7.a.a.j.LinearLayoutCompat, n, 0);
    ...
    void a(final int n, final int n2) {
        ...
        for (int i = 0; i < virtualChildCount; ++i, n26 = n14, n27 = n13, n10 = n16, n9 = n15, n4 = n26, n3 = n27) {
            ...
            if (b2 == null) {
                ...
                final int combineMeasuredStates = View.combineMeasuredStates(n4, b2.getMeasuredState());
                if (n7 != 0 && a.width == -1) {
                    n7 = 1;
                }
                else {
        ...
        if (h && (mode2 == Integer.MIN_VALUE || mode2 == 0)) {
            ...
            for (int j = 0; j < virtualChildCount; ++j) {
                ...
                if (b4 == null) {
                    ...
                    final a a2 = (a)b4.getLayoutParams();
                    final int f4 = this.f;
                    this.f = Math.max(f4, a2.bottomMargin + (f4 + n10 + a2.topMargin) + this.b(b4));
                }
            }
        }
        this.f += this.getPaddingTop() + this.getPaddingBottom();
        final int resolveSizeAndState = View.resolveSizeAndState(Math.max(this.f, this.getSuggestedMinimumHeight()), n2, 0);
        final int n28 = (0xFFFFFF & resolveSizeAndState) - this.f;
        int n33;
        int n52;
        if (n9 != 0 || (n28 != 0 && g > 0.0f)) {
            ...
            while (k < virtualChildCount) {
                ...
                if (b5.getVisibility() == 8) {
                    ...
                    final a a3 = (a)b5.getLayoutParams();
                    final float g2 = a3.g;
                    int n42;
                    int n43;
                    if (g2 > 0.0f) {
                        final int n38 = (int)(n35 * g2 / g);
                        final int childMeasureSpec = getChildMeasureSpec(n, this.getPaddingLeft() + this.getPaddingRight() + a3.leftMargin + a3.rightMargin, a3.width);
                        ...
                        final int combineMeasuredStates2 = View.combineMeasuredStates(n4, b5.getMeasuredState() & 0xFFFFFF00);
                    ...
                    final int n45 = a3.leftMargin + a3.rightMargin;
                    ...
                    final int f5 = this.f;
                    this.f = Math.max(f5, a3.bottomMargin + (b5.getMeasuredHeight() + f5 + a3.topMargin) + this.b(b5));
                    n37 = max6;
                    final int n49 = n43;
                    n4 = n42;
                    n35 = n49;
        ...
        this.setMeasuredDimension(View.resolveSizeAndState(Math.max(n52 + (this.getPaddingLeft() + this.getPaddingRight()), this.getSuggestedMinimumWidth()), n, n4), resolveSizeAndState);
        if (n8 != 0) {
    ...
    void a(int i, int n, int n2, int h) {
        ...
        for (i = n2; i < virtualChildCount; ++i) {
            ...
            if (b == null) {
                ...
                switch (android.support.v4.h.d.a(n2, p.b((View)this)) & 0x7) {
                    default: {
    ...
    void b(final int n, final int n2) {
        ...
        if (h && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            for (int l = 0; l < virtualChildCount; ++l) {
                ...
                if (b4 == null) {
                    ...
                    if (b) {
                        this.f += a3.rightMargin + (a3.leftMargin + n10) + this.b(b4);
                    }
                    else {
                        final int f4 = this.f;
                        this.f = Math.max(f4, a3.rightMargin + (f4 + n10 + a3.leftMargin) + this.b(b4));
                    }
                }
            }
        }
        this.f += this.getPaddingLeft() + this.getPaddingRight();
        final int resolveSizeAndState = View.resolveSizeAndState(Math.max(this.f, this.getSuggestedMinimumWidth()), n, 0);
        final int n34 = (0xFFFFFF & resolveSizeAndState) - this.f;
        int max8;
        int n60;
        int n61;
        int n62;
            ...
            while (n39 < virtualChildCount) {
                ...
                if (b5 != null) {
                    if (b5.getVisibility() == 8) {
                        ...
                        final a a4 = (a)b5.getLayoutParams();
                        final float g2 = a4.g;
                        if (g2 > 0.0f) {
                            final int n45 = (int)(n37 * g2 / g);
                            final int n46 = n37 - n45;
                            final int childMeasureSpec = getChildMeasureSpec(n2, this.getPaddingTop() + this.getPaddingBottom() + a4.topMargin + a4.bottomMargin, a4.height);
                            ...
                            combineMeasuredStates2 = View.combineMeasuredStates(combineMeasuredStates2, b5.getMeasuredState() & 0xFF000000);
                            g -= g2;
                            n37 = n46;
                        }
                        if (b) {
                            this.f += b5.getMeasuredWidth() + a4.leftMargin + a4.rightMargin + this.b(b5);
                        }
                        else {
                            final int f5 = this.f;
                            this.f = Math.max(f5, b5.getMeasuredWidth() + f5 + a4.leftMargin + a4.rightMargin + this.b(b5));
                        }
                        int n49;
                        if (mode2 != 1073741824 && a4.height == -1) {
                            n49 = 1;
                        }
                        else {
                            n49 = 0;
                        }
                        final int n50 = a4.topMargin + a4.bottomMargin;
        ...
        this.setMeasuredDimension((0xFF000000 & n60) | resolveSizeAndState, View.resolveSizeAndState(Math.max(n62 + (this.getPaddingTop() + this.getPaddingBottom()), this.getSuggestedMinimumHeight()), n2, n60 << 16));
        if (n8 != 0) {
    ...
    void b(int n, int i, int n2, int n3) {
        final boolean a = bc.a((View)this);
        ...
        final int[] j = this.i;
        final int[] k = this.j;
        switch (android.support.v4.h.d.a(i & 0x800007, p.b((View)this))) {
            default: {
    ...
    public void onInitializeAccessibilityEvent(final AccessibilityEvent accessibilityEvent) {
        if (Build$VERSION.SDK_INT >= 14) {
            ...
            accessibilityEvent.setClassName((CharSequence)ai.class.getName());
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(final AccessibilityNodeInfo accessibilityNodeInfo) {
        if (Build$VERSION.SDK_INT >= 14) {
            ...
            accessibilityNodeInfo.setClassName((CharSequence)ai.class.getName());
        }
    }
