...
public class c extends h implements android.support.b.a.b
{
    ...
    private c(final Context d, final a c, final Resources resources) {
        ...
        this.a = (Drawable$Callback)new Drawable$Callback() {
            public void invalidateDrawable(final Drawable drawable) {
                android.support.b.a.c.this.invalidateSelf();
            }
            
            public void scheduleDrawable(final Drawable drawable, final Runnable runnable, final long n) {
                android.support.b.a.c.this.scheduleSelf(runnable, n);
            }
            
            public void unscheduleDrawable(final Drawable drawable, final Runnable runnable) {
                android.support.b.a.c.this.unscheduleSelf(runnable);
            }
        };
        this.d = d;
        if (c != null) {
    ...
    private void a(final String s, final Animator animator) {
        ...
        if (this.c.e == null) {
            ...
            this.c.d = new android.support.v4.g.a<Animator, String>();
        }
        ...
        for (int n = xmlPullParser.getEventType(), depth = xmlPullParser.getDepth(); n != 1 && (xmlPullParser.getDepth() >= depth + 1 || n != 3); n = xmlPullParser.next()) {
            if (n == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    final TypedArray a = android.support.v4.b.a.c.a(resources, resources$Theme, set, android.support.b.a.a.e);
                    final int resourceId = a.getResourceId(0, 0);
                    if (resourceId != 0) {
                        final i a2 = i.a(resources, resourceId, resources$Theme);
                        a2.a(false);
                    ...
                    final TypedArray obtainAttributes = resources.obtainAttributes(set, android.support.b.a.a.f);
                    ...
                    if (resourceId2 != 0) {
                        ...
                        this.a(string, android.support.b.a.e.a(this.d, resourceId2));
                    }
                    obtainAttributes.recycle();
                }
            }
    ...
    public void setAutoMirrored(final boolean autoMirrored) {
        if (this.b != null) {
            android.support.v4.c.a.a.a(this.b, autoMirrored);
            return;
        }
        ...
        public a(final Context context, final a a, final Drawable$Callback callback, final Resources resources) {
            ...
            if (a != null) {
                ...
                if (a.b != null) {
                    ...
                    (this.b = (i)this.b.mutate()).setCallback(callback);
                ...
                if (a.e != null) {
                    ...
                    this.d = new android.support.v4.g.a<Animator, String>(size);
                    while (i < size) {
